            ...
            <div className="bg-[#f4f3f2] rounded-xl p-8 border border-[#c3bebb]/30">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { icon: <Calendar className="w-5 h-5" />, label: "Total Duration", val: "3 Months" },
                ...
                <div className="flex items-center justify-between p-4 bg-white rounded-lg shadow-sm border-l-4 border-[#c3bebb]">
                  ...
                  <div className="text-right">
                    <span className="font-bold text-gray-900">Practical 90%</span>
                    <span className="text-xs text-gray-500 block">Theory 10%</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="flex border-b border-gray-200 overflow-x-auto">
            <button
              ...
              className={`px-6 py-4 font-semibold transition-all duration-300 border-b-2 whitespace-nowrap ${activeTab === "overview"
            ...
            <button
              ...
              className={`px-6 py-4 font-semibold transition-all duration-300 border-b-2 whitespace-nowrap ${activeTab === "assessment"
                  ? "border-black text-black"
                  : "border-transparent text-gray-500 hover:text-gray-700"
                }`}
            >
            ...
            <button
              ...
              className={`px-6 py-4 font-semibold transition-all duration-300 border-b-2 whitespace-nowrap ${activeTab === "personalization"
                  ? "border-black text-black"
                  : "border-transparent text-gray-500 hover:text-gray-700"
                }`}
            >
