      ...
      return (
        <li key={sub.id}>
          <button
            type="button"
            onClick={() =>
              router.push(`/course2/content?title=${encodeURIComponent(sub.title)}`)
            }
            className="w-full flex items-center gap-2 rounded-md px-2 py-1 text-left text-sm text-gray-700 hover:bg-gray-100 transition-colors cursor-pointer"
          >
