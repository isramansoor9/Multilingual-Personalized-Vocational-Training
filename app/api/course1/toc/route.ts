  ...
  practicalTopics: [
    ...
    },
    {
      ...
      subtopics: [
        ...
        { id: "P8.2", title: "Legal requirements" },
        { id: "P8.3", title: "Making thimble connectors(Practical)" },
        {
          id: "P8.4",
          title: "Color codes of Wiring Circuits on Wiring Board",
        },
        { id: "P8.5", title: "Head lamp circuit with relay(Practical)" },
        { id: "P8.6", title: "Aiming headlights(Practical)" },
        { id: "P8.7", title: "Parking brake circuit(Practical)" },
        { id: "P8.8", title: "Hazard warning circuit(Practical)" },
        { id: "P8.9", title: "Indicator circuit(Practical)" },
        { id: "P8.10", title: "Brake light circuit(Practical)" },
        { id: "P8.11", title: "Reverse gear light circuits(Practical)" },
        { id: "P8.12", title: "Door and roof light circuit(Practical)" },
        { id: "P8.13", title: "Horn circuit and adjustment(Practical)" },
        { id: "P8.14", title: "Fuel gauge circuit(Practical)" },
        { id: "P8.15", title: "Oil pressure light circuit(Practical)" },
        { id: "P8.16", title: "Trunk and hood light(Practical)" },
        { id: "P8.17", title: "Temperature gauge circuit(Practical)" },
        {
          id: "P8.18",
          title: "Brake fluid level light circuit(Practical)",
        },
        { id: "P8.19", title: "Power window circuit(Practical)" },
        {
          id: "P8.20",
          title: "Wind shield and wiper motor circuit(Practical)",
        },
        { id: "P8.21", title: "Electric Fan circuit(Practical)" },
        { id: "P8.22", title: "Glow plug circuit(Practical)" },
        {
          id: "P8.23",
          title: "Electrical shut off valve circuit(Practical)",
        },
        { id: "P8.24", title: "Radio and speaker circuit(Practical)" },
        {
          id: "P8.25",
